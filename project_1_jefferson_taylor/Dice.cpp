...
int Dice::GetDiceAmount() const { return dice_amount_; }

int Dice::GetDiceSides() const { return dice_sides_; }

int Dice::GetLowestRoll() const { return lowest_roll_; }

int Dice::GetHighestRoll() const { return highest_roll_; }
